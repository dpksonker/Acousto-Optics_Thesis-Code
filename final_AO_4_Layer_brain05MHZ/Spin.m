...
if gg == 0                                                                 % Check if g is 0
    ...
    theta = single(acos(2*rand() - 1));                                            % Calculate theta using random number

else

    temp1 = (1 - gg*gg)/(1 - gg + 2*gg*rand());
    temp2 = (1/(2*gg))*((1+gg*gg) - temp1*temp1);
    ...
    theta = single(acos(temp2));                    % Calculate theta using Henyey-Greenstein function
end

psi = single(2*pi*rand());                                                         % Calculate phi using random number
