function [Bound,Tissue,AO,M0,M1] = AO_05MHz_water(Bound,Tissue,n,n_photons,W,AO,M0,M1)
%% The function AO_05MHz_water is the main Monte Carlo simulation function it calculates the total phase modulations due to both AO mechanisms and stores the phase modulations 
