...
AO.Pressure = n_p/5.4915e3;                                                     % normalize the US pressure to 1 kPa
...
Tissue.d4 = single(38.5);                                                   % Tickness of fourth layer
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
n_photons = 1e9;                                                                       % Total Number of Photons to be simulated
W = single(0.0001);                                                                      % Threshold weight for Roulette

% [Bound,Tissue,AO,M0,M1] = AO_09MHz_4Layer_BRAIN(Bound,Tissue,n,n_photons,W,AO,M0,M1);       % Main calling function to simulate the Monte Carlo
[Bound,Tissue,AO,M0,M1] = AO_09MHz_4Layer_BRAIN_mex(Bound,Tissue,n,n_photons,W,AO,M0,M1);

Data_09MHzFUS_4lBRAIN(1:9,:) = {Tissue.mod1(1:Tissue.count_D1,:),"Tissue.Mod1";Tissue.mod2(1:Tissue.count_D2,:),"Tissue.Mod2";Tissue.mod3(1:Tissue.count_D3,:),"Tissue.Mod3";Tissue.phi1(1:Tissue.count_D1,:),"Tissue.phi1";Tissue.phi2(1:Tissue.count_D2,:),"Tissue.phi2";Tissue.phi3(1:Tissue.count_D3,:),"Tissue.phi3";...
...
% saveas(gcf,'Data_09MHzFUS_4lBRAIN.mat')
...
saveas(gcf,'FUS_Unmodulated_09MHz.fig')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
saveas(gcf,'FUS_modulated_09MHz.fig')
...
saveas(gcf,'FUS_MDepth_09MHz.fig')
